...
from endpoints.transit_range import transit_range
...
class TestTransitRangeAspects(unittest.TestCase):
    ...
    def test_aspects_default_to_disabled(self):
        ...
        self.assertIsNone(snap.natal_subject)
        self.assertIsNone(snap.natal_aspects)
        self.assertIsNone(snap.natal_major_aspects)
    ...
    def test_aspects_can_be_enabled(self):
        ...
        self.assertIsNotNone(snap.natal_subject)
        self.assertIsInstance(snap.natal_aspects, list)
        self.assertIsInstance(snap.natal_major_aspects, list)
