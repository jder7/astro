      ...
      {#if layerCount === 1 && layers[0]?.summarySigil}
        <div class="adv-sky-summary-badge" aria-label="Chart summary sigil" title="Chart summary sigil">
          <ElementSigil
            ...
            sunSign={layers[0].summarySigil.sunSign}
            moonSign={layers[0].summarySigil.moonSign}
            ascSign={layers[0].summarySigil.ascSign}
            daySign={layers[0].summarySigil.daySign}
          />
        </div>
      {/if}
    </div>
