...
<div class="glass-card p-4 space-y-3" id="config-panel">
  ...
  <div class="micro-grid text-xs sm:text-sm" id="config-layout">
    <div class="space-y-1">
      <label class="micro-label" for="config-perspective">Perspective</label>
      <select id="config-perspective" class="flowbite-input flowbite-select" value={config.perspective} on:change={(e) => updateConfig({ perspective: e.target.value })}>
    ...
    <div class="space-y-1">
      <label class="micro-label" for="config-zodiac">Zodiac</label>
      <select id="config-zodiac" class="flowbite-input flowbite-select" value={config.zodiac_type} on:change={(e) => updateConfig({ zodiac_type: e.target.value })}>
    ...
    {#if config.zodiac_type === 'Sidereal'}
      <div class="space-y-1">
        <label class="micro-label" for="config-sidereal">Sidereal</label>
        <select id="config-sidereal" class="flowbite-input flowbite-select" value={config.sidereal_mode} on:change={(e) => updateConfig({ sidereal_mode: e.target.value })}>
    ...
    {/if}
    <div class="space-y-1">
      <label class="micro-label" for="config-houses">Houses</label>
      <select id="config-houses" class="flowbite-input flowbite-select" value={config.house_system} on:change={(e) => updateConfig({ house_system: e.target.value })}>
    ...
    <div class="space-y-1">
      <label class="micro-label" for="config-theme">Theme</label>
      <select id="config-theme" class="flowbite-input flowbite-select" value={config.theme} on:change={(e) => updateConfig({ theme: e.target.value })}>
