...
<div class="glass-card p-4 space-y-3">
  ...
  <div class="form-row">
    ...
    <div class="form-row-actions">
      <button
        type="button"
        class="inline-flex items-center gap-2 rounded-full border border-slate-700 bg-slate-800/80 px-3 py-2 text-xs font-semibold text-slate-100 shadow-sm hover:border-cyan-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-cyan-500 text-left justify-between min-w-0"
