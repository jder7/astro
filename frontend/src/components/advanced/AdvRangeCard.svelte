...
<style>
  ...
  .range-sigil {
    ...
    align-items: center;
    justify-content: center;
    background: radial-gradient(circle at 50% 30%, color-mix(in srgb, var(--tone, #38bdf8) 18%, transparent), transparent 65%);
    border: 1px dashed color-mix(in srgb, var(--tone, #38bdf8) 38%, #0f172a);
    border-radius: 14px;
    padding: 12px;
    min-width: 120px;
  }
